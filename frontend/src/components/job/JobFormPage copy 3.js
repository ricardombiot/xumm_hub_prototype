...
export default class JobFormPage extends Component {
    ...
    constructor(props) {
        super(props);
        this.form =  new ControlledFormComponent(this, {}, this.onSubmit);
...
/*    handleInputChange(event){
        this.form.handleInputChange(event);
    }
*/
...
<div class="box_account">
    ...
    <div class="form_container">
        ...
        <div class="text-center"><button type="submit" class="btn_1 full-width" onsubmit={this.form.handleSubmit}>Publish now!</button></div>
    </div>
