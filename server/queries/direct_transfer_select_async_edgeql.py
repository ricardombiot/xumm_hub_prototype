...
class DirectTransferSelectResult(NoPydanticValidation):
    id: uuid.UUID
    quotation: typing.Optional[DirectTransferSelectResultQuotation]
    owner: typing.Optional[DirectTransferSelectResultOwner]
    payload: typing.Optional[str]
    is_checked: typing.Optional[bool]
...
async def direct_transfer_select(
    ...
    *,
    ...
    owner_id: uuid.UUID,
) -> typing.Optional[DirectTransferSelectResult]:
